...
Se corrige error de modificación de archivos .svg provocado por stroke="currentColor", ahora los .svg que contengan el valor "currentColor" pueden ser modificados por un color en código Hexadecimal 
...
> # Licencia Este proyecto está bajo la licencia Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0).